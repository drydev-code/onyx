...
const GOOGLE_AI_STUDIO_PROVIDER_NAME = "google_ai_studio";
...
export default function GoogleAIStudioModal({
  ...
  const initialValues = isOnboarding
    ? {
        ...buildOnboardingInitialValues(),
        name: GOOGLE_AI_STUDIO_PROVIDER_NAME,
        provider: GOOGLE_AI_STUDIO_PROVIDER_NAME,
        api_key: "",
  ...
  return (
      ...
      onSubmit={async (values, { setSubmitting }) => {
        if (isOnboarding && onboardingState && onboardingActions) {
          ...
          await submitOnboardingProvider({
            providerName: GOOGLE_AI_STUDIO_PROVIDER_NAME,
            payload: {
              ...values,
    ...
    >
      {(formikProps) => (
        <LLMConfigurationModalWrapper
          providerEndpoint={GOOGLE_AI_STUDIO_PROVIDER_NAME}
        ...
        >
          ...
          <FieldSeparator />
          {isOnboarding ? (
            <SingleDefaultModelField placeholder="E.g. gemini-3-pro-preview" />
          ) : (
            <ModelsField
