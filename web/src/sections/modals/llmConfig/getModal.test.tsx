...
jest.mock("@/sections/modals/llmConfig/ZAIModal", () => ({
  __esModule: true,
  default: () => <div data-testid="ZAIModal" />,
}));

jest.mock("@/sections/modals/llmConfig/GoogleAIStudioModal", () => ({
  __esModule: true,
  default: () => <div data-testid="GoogleAIStudioModal" />,
}));
...
describe("getModalForExistingProvider", () => {
  const cases: [string, Partial<LLMProviderView>, string][] = [
    // New providers added in this branch
    [
      "routes ZAI to ZAIModal",
      { provider: LLMProviderName.ZAI },
      "ZAIModal",
    ],
    [
      "routes GOOGLE_AI_STUDIO to GoogleAIStudioModal",
      { provider: LLMProviderName.GOOGLE_AI_STUDIO },
      "GoogleAIStudioModal",
    ],
    [
