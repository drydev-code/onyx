...
import { Content, Card as OpalCard } from "@opal/layouts";
...
> = {
  ...
  zai: (d, onOpenChange) => (
    <ZAIModal shouldMarkAsDefault={d} onOpenChange={onOpenChange} />
  ),
  google_ai_studio: (d, onOpenChange) => (
    <GoogleAIStudioModal shouldMarkAsDefault={d} onOpenChange={onOpenChange} />
  ),
  openai_codex: (d, onOpenChange) => (
    <CodexModal shouldMarkAsDefault={d} onOpenChange={onOpenChange} />
  ),
  claude_code_cli: (d, onOpenChange) => (
    <ClaudeCodeCLIModal shouldMarkAsDefault={d} onOpenChange={onOpenChange} />
  ),
};
